      ...
      <div className="container login-container d-flex align-items-center justify-content-center">
        <div className="row">
          ...
          <div className="col-lg-5 col-md-12">
            <div className="card p-5 rounded-3 shadow">
              <input
                type="text"
              ...
              />
              <a className="btn btn-primary btn-lg" href="/profile">
                Log in
              </a>
              <a href="/forgot" className="btn btn-link mt-2">
                Forgot password ?
              </a>
              <hr />
              <button
                className="btn btn-success btn-lg align-self-center"
        ...
        >
          <div className="modal-content shadow">
            <div className="modal-header">
              <div className="col">
                <h5 className="modal-title display-6" id="sign-up-modal">
                  Sign Up
                </h5>
              ...
              <button
                type="button"
                className="btn-close mb-5 btn-lg"
            ...
            <div class="modal-footer">
              <small className="text-secondary policy">
            ...
            <button className="btn btn-success btn-lg align-self-center mb-3 ps-5 pe-5">
              Sign Up
            </button>
          </div>
        </div>
