          ...
          <div className="col-3 pt-4 left-container me-5">
            <Scrollbar>
              <div className="col-lg-9 col-md-12 left-container-content">
                ...
                ></LeftComponent>
                <LeftComponent
                  image="./images/left_img1.png"
                  text="Friends"
                ></LeftComponent>
                <LeftComponent
                  image="./images/left_img2.png"
                  text="Groups"
                ></LeftComponent>
                <LeftComponent
                  image="./images/left_img3.png"
                  text="Marketplace"
                ></LeftComponent>
                <LeftComponent
                  image="./images/left_img4.png"
                  text="Watch"
                ></LeftComponent>
                <LeftComponent
                  image="./images/left_img5.png"
                  text="Memories"
                ></LeftComponent>
                <LeftComponent
                  image="./images/left_img6.png"
                  text="Saved"
                ></LeftComponent>
                <LeftComponent
                  image="./images/left_img7.png"
                  text="Pages"
                ></LeftComponent>
                <LeftComponent
                  image="./images/left_img9.png"
                  text="Most recent"
                ></LeftComponent>
                <LeftComponent
                  image="./images/left_img10.png"
                  text="Favorites"
                ></LeftComponent>
                {!seeMore ? (
                  <a
                  ...
                  >
                    <div className="d-flex left-box-element ps-2 pt-2 pb-2 rounded">
                      <a className="nav-link me-4 ms-1">
                        <i className=" bgprimary bx bx-chevron-down bx-sm bx-border-circle color-black"></i>
                      </a>
                ...
                {seeMore ? (
                  <>
                    <LeftComponent
                      image="./images/left_img8.png"
                      text="Events"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img11.png"
                      text="Recent Ad Activity"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img12.png"
                      text="Climate Science Center"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img13.png"
                      text="Fundraisers"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img14.png"
                      text="COVID-19 Information Centre"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img15.png"
                      text="Ad Centre"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img16.png"
                      text="Facebook Pay"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img17.png"
                      text="Ad Manager"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img18.png"
                      text="Play Games"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img19.png"
                      text="Messenger"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img20.png"
                      text="Messenger Kids"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img21.png"
                      text="Emotional Health"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img22.png"
                      text="Crisis service"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img23.png"
                      text="Gaming Videos"
                    ></LeftComponent>
                    <LeftComponent
                      image="./images/left_img24.png"
                      text="Live Videos"
                    ></LeftComponent>
                    <a
                      onClick={() => {
                    ...
                    >
                      <div className="d-flex left-box-element ps-2 pt-2 pb-2 rounded">
                        <a className="nav-link me-4 ms-1">
                          <i className=" bgprimary bx bx-chevron-up bx-sm bx-border-circle color-black"></i>
                        </a>
              ...
              <div className="col-5 d-flex justify-content-end">
                ...
                >
                  <a href="#" className="me-3 text-secondary">
                    <i className="bx bxs-camera-movie bx-sm"></i>
                  </a>
                </OverlayTrigger>
